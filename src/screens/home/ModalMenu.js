                    ...
                    <View style={styles.modalView}>
                        <View style={{ ...commonStyles.rowStart, alignItems: 'center' }}>
                            <View>
                                {userData?.userProfile !== undefined
                                    ? <Image
                                        ...
                                        style={{ width: 80, height: 80, borderRadius: 100, marginTop: 6, borderWidth: 2, borderColor: "#E27127" }}
                                    />
                                    : <View style={{ width: 80, height: 80, backgroundColor: "#f7f8f9", borderRadius: 100, ...commonStyles.centerStyles }}>
                                        <Image
                            ...
                            <View style={{ marginLeft: 9, marginTop: -5 }}>
                                ...
                                <TouchableHighlight style={{ ...styles.switchAccount }}
                                    underlayColor="#eee"
                                    onPress={async () => {
                                ...
                                >
                                    <View style={{ ...commonStyles.rowBetween }}>
                                        <Text style={{ ...commonStyles.fs13_400 }}>Shop Owner</Text>
                                        <Image
