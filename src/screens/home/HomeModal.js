...
import { Modal, StyleSheet, Text, View, TouchableHighlight, Image, TextInput, TouchableOpacity } from "react-native";
                    ...
                    <TouchableOpacity style={styles.modalView} activeOpacity={1}>
                        ...
                        {showCheck ? <View style={{ marginVertical: 10 }}>
                            <TextInput
                                ...
                                onChangeText={(val) => { setIsChecked(val); setError(false) }}
                                style={{ ...styles.reportInput }}
                            />
                            {error ? <Text style={{ ...commonStyles.fs13_400, color: "red", marginTop: -6, marginBottom: 6 }}>
                                ! Feedback required
                            </Text> : <></>}
...
function SubmitFeedbackbtn({ btnText, onPress }) {
    return (
        <LinearGradient colors={['#E27127', '#EDAA26']} style={{ zIndex: 1, borderRadius: 4, marginTop: 6 }}>
