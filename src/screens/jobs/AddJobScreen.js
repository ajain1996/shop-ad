...
export default function AddJobScreen({ navigation }) {
    ...
    const [contactPersonNameError, setContactPersonNameError] = React.useState(false);
                ...
                {showNext.next1 ? <View style={{ paddingHorizontal: 16 }}>
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor="#999"
                            value={shopName}
                            onChangeText={(val) => { setShopName(val); setShopNameError(false); }}
                            style={[styles.titleInput, { borderColor: shopNameError ? "red" : "#BDBDBD" }]}
                        />
                        {shopNameError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Shop name is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor="#999"
                            value={address}
                            onChangeText={(val) => { setAddress(val); setAddressError(false) }}
                            style={[styles.titleInput, { borderColor: addressError ? "red" : "#BDBDBD" }]}
                        />
                        {addressError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Address of firm is mandatory</Text>
                            : <></>}
                    </>
                ...
                {showNext.next2 ? <View style={{ paddingHorizontal: 16 }}>
                    <>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor="#999"
                            value={areaOfWork}
                            onChangeText={(val) => { setAreaOfWork(val); setAreaOfWorkError(false) }}
                            style={[styles.titleInput, { borderColor: areaOfWorkError ? "red" : "#BDBDBD" }]}
                        />
                        {areaOfWorkError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Area of work is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor="#999"
                            value={experience}
                            onChangeText={(val) => { setExperience(val); setExperienceError(false) }}
                            style={[styles.titleInput, { borderColor: experienceError ? "red" : "#BDBDBD" }]}
                        />
                        {experienceError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Experience Required is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        />
                        {manPowerError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Number of Manpower is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor="#999"
                            value={workTiming}
                            onChangeText={(val) => { setWorkTiming(val); setWorkTimingError(false) }}
                            style={[styles.titleInput, { borderColor: workTimingError ? "red" : "#BDBDBD" }]}
                        />
                        {workTimingError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Work Timing is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            onChangeText={(val) => { setVehicleRequired(val); setVehicleRequiredError(false) }}
                            style={[styles.titleInput, { borderColor: vehicleRequiredError ? "red" : "#BDBDBD" }]}
                        />
                        {vehicleRequiredError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Vehicle required is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        />
                        {facilitiesError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Facility is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    <>
                        ...
                        />
                        {incentiveError
                            ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Incentive is mandatory</Text>
                            : <></>}
                    </>
                    ...
                    ? <View style={{ paddingHorizontal: 16 }}>
                        ...
                        <>
                            ...
                            <TextInput
                                ...
                                maxLength={10}
                                onChangeText={(val) => { setInterviewTiming(val); setInterviewTimingError(false) }}
                                style={[styles.titleInput, { borderColor: interviewTimingError ? "red" : "#BDBDBD" }]}
                            />
                            {interviewTimingError
                                ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Interview timing is mandatory</Text>
                                : <></>}
                        </>
                        {/* <PersonalLeaveDatePicker
                        ...
                        <>
                            ...
                            <TextInput
                                ...
                                maxLength={10}
                                onChangeText={(val) => { setContactNumber(val); setContactNumberError(false) }}
                                style={[styles.titleInput, { borderColor: contactNumberError ? "red" : "#BDBDBD" }]}
                            />
                            {contactNumberError
                                ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Contact number is mandatory</Text>
                                : <></>}
                        </>
                        ...
                        <>
                            ...
                            <TextInput
                                ...
                                onChangeText={(val) => { setContactPersonName(val); setContactPersonNameError(false); }}
                                style={[styles.titleInput, { borderColor: contactPersonNameError ? "red" : "#BDBDBD" }]}
                            />
                            {contactPersonNameError
                                ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Contact person name is mandatory</Text>
                                : <></>}
                        </>
                        ...
                        <>
                            ...
                            <TextInput
                                ...
                                multiline={true}
                                textAlignVertical="top"
                                onChangeText={(val) => { setMessage(val); setMessageError(false); }}
                                style={[styles.descriptionInput, { borderColor: messageError ? "red" : "#BDBDBD" }]}
                            />
                            {messageError
                                ? <Text style={{ ...commonStyles.fs12_400, color: "red" }}>Message is mandatory</Text>
                                : <></>}
                        </>
                        <View style={{ marginTop: 20 }} />
